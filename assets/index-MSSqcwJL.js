...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ai,depthTest:!1,depthWrite:!1})}function lo(){return new mi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:za(),fragmentShader:`
		...
		`,blending:ai,depthTest:!1,depthWrite:!1})}function co(){return new mi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:za(),fragmentShader:`
...
`].filter(wr).join(`
`)),o=Ha(o),o=bo(o,t),o=Ao(o,t),s=Ha(s),s=bo(s,t),s=Ao(s,t),o=wo(o),s=wo(s),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
